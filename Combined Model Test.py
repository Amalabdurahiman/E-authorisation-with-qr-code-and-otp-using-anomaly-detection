...
# Combine the predictions by averaging (you can also use other methods like majority voting)
...
# Print the results for the combined model
print("Combined Model Results (Isolation Forest + One-Class SVM):")
